...
import { LayoutDashboard, PieChart, Receipt, Users, LogOut, GraduationCap, Bell, Target } from 'lucide-react';
  ...
  return (
    <aside className={`sidebar glass-panel ${isOpen ? 'sidebar-open' : ''}`}>
      ...
      <nav className="sidebar-nav">
        ...
        <Link href="/employee-target-sheet" className={pathname === '/employee-target-sheet' ? "nav-item active" : "nav-item"} onClick={() => setIsOpen(false)}>
          <Target size={20} />
          <span>Employee Target Sheet</span>
        </Link>
